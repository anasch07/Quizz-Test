...
var state = {
    questions: [{
            text: "In which year of First World War Germany declared war on Russia and France?",
            choices: ["1914", "1915", "1916", "1917"],
            correctChoiceIndex: 0
        },
        {
            text: "India has largest deposits of ____ in the world.?",
            choices: ["gold", "copper", "mica", "None of the above"],
            correctChoiceIndex: 2
        },
        {
            text: "If speed of rotation of the earth increases, weight of the body? ",
            choices: ["increases", "remains unchanged", "decreases", "may decrease or increase"],
            correctChoiceIndex: 2,
        },
        {
            text: "How many players are there on each side in the game of Basketball?",
            choices: ["4", "5", "6", "7"],
            correctChoiceIndex: 1,
        },
        {
            text: "Joule is the unit of",
